...
/**
 * @ngdoc object
 * @name lbServices.employeeitem
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `employeeitem` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', function(Resource, LoopBackAuth) {
    return Resource(
      ...
      { 'id': '@id' },
      {
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#create
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#updateOrCreate
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#upsert
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#exists
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/employee/:id/exists",
          method: "GET",

        },
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#findById
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/employee/:id",
          method: "GET",

        },
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#find
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#findOne
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/employee/findOne",
          method: "GET",

        },
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#destroyById
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#deleteById
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#removeById
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#count
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/employee/count",
          method: "GET",

        },
        /**
         * @ngdoc method
         * @name lbServices.employeeitem#prototype$updateAttributes
         * @methodOf lbServices.employeeitem
         *
         * @description
         *
